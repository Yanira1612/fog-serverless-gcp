...
db_name = "default-firestore-9c92172" # <--- PON EL NOMBRE DE TU BD AQUÍ (el que vimos en la foto: default-firestore-xxxx)
...
def generate_fake_data():
    ...
    while current_date < end_date:
        ...
        current_date += timedelta(minutes=90)
